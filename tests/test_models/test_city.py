...
class TestCity_instance(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        cystr = cy.__str__()
        self.assertIn("[City] (fgh456)", cystr)
        self.assertIn("'id': 'fgh456'", cystr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        cy = City(id="007", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(cy.id, "007")
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        cy = City()
        cy.middle_name = "Accra"
        cy.my_number = 233
        self.assertEqual("Accra", cy.middle_name)
