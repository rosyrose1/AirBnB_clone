...
class TestUser_constructor(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        usstr = us.__str__()
        self.assertIn("[User] (abcde3f)", usstr)
        self.assertIn("'id': 'abcde3f'", usstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        us = User(id="007", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(us.id, "007")
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "Soweto"
        us.my_number = 23
        self.assertEqual("Soweto", us.middle_name)
